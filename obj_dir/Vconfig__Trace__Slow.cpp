...
void Vconfig___024root__traceInitSub0(Vconfig___024root* vlSelf, VerilatedVcd* tracep) VL_ATTR_COLD;
...
void Vconfig___024root__traceInitTop(Vconfig___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        Vconfig___024root__traceInitSub0(vlSelf, tracep);
    }
}

void Vconfig___024root__traceInitSub0(Vconfig___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    // Body
    {
        ...
        {int i; for (i=0; i<32; i++) {
                tracep->declQuad(c+77+i*2,"top common_reg ram", true,(i+0), 63,0);}}
...
void Vconfig___024root__traceFullTop0(void* voidSelf, VerilatedVcd* tracep) VL_ATTR_COLD;
...
void Vconfig___024root__traceRegister(Vconfig___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->addFullCb(&Vconfig___024root__traceFullTop0, vlSelf);
        tracep->addChgCb(&Vconfig___024root__traceChgTop0, vlSelf);
        tracep->addCleanupCb(&Vconfig___024root__traceCleanup, vlSelf);
    }
}

void Vconfig___024root__traceFullSub0(Vconfig___024root* vlSelf, VerilatedVcd* tracep) VL_ATTR_COLD;

void Vconfig___024root__traceFullTop0(void* voidSelf, VerilatedVcd* tracep) {
    Vconfig___024root* const __restrict vlSelf = static_cast<Vconfig___024root*>(voidSelf);
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    {
        Vconfig___024root__traceFullSub0((&vlSymsp->TOP), tracep);
    }
}

void Vconfig___024root__traceFullSub0(Vconfig___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+76,((7U & (vlSelf->top__DOT__inst 
                                          >> 0xcU))),3);
        tracep->fullQData(oldp+77,(vlSelf->top__DOT__common_reg__DOT__ram[0]),64);
        tracep->fullQData(oldp+79,(vlSelf->top__DOT__common_reg__DOT__ram[1]),64);
        tracep->fullQData(oldp+81,(vlSelf->top__DOT__common_reg__DOT__ram[2]),64);
        tracep->fullQData(oldp+83,(vlSelf->top__DOT__common_reg__DOT__ram[3]),64);
        tracep->fullQData(oldp+85,(vlSelf->top__DOT__common_reg__DOT__ram[4]),64);
        tracep->fullQData(oldp+87,(vlSelf->top__DOT__common_reg__DOT__ram[5]),64);
        tracep->fullQData(oldp+89,(vlSelf->top__DOT__common_reg__DOT__ram[6]),64);
        tracep->fullQData(oldp+91,(vlSelf->top__DOT__common_reg__DOT__ram[7]),64);
        tracep->fullQData(oldp+93,(vlSelf->top__DOT__common_reg__DOT__ram[8]),64);
        tracep->fullQData(oldp+95,(vlSelf->top__DOT__common_reg__DOT__ram[9]),64);
        tracep->fullQData(oldp+97,(vlSelf->top__DOT__common_reg__DOT__ram[10]),64);
        tracep->fullQData(oldp+99,(vlSelf->top__DOT__common_reg__DOT__ram[11]),64);
        tracep->fullQData(oldp+101,(vlSelf->top__DOT__common_reg__DOT__ram[12]),64);
        tracep->fullQData(oldp+103,(vlSelf->top__DOT__common_reg__DOT__ram[13]),64);
        tracep->fullQData(oldp+105,(vlSelf->top__DOT__common_reg__DOT__ram[14]),64);
        tracep->fullQData(oldp+107,(vlSelf->top__DOT__common_reg__DOT__ram[15]),64);
        tracep->fullQData(oldp+109,(vlSelf->top__DOT__common_reg__DOT__ram[16]),64);
        tracep->fullQData(oldp+111,(vlSelf->top__DOT__common_reg__DOT__ram[17]),64);
        tracep->fullQData(oldp+113,(vlSelf->top__DOT__common_reg__DOT__ram[18]),64);
        tracep->fullQData(oldp+115,(vlSelf->top__DOT__common_reg__DOT__ram[19]),64);
        tracep->fullQData(oldp+117,(vlSelf->top__DOT__common_reg__DOT__ram[20]),64);
        tracep->fullQData(oldp+119,(vlSelf->top__DOT__common_reg__DOT__ram[21]),64);
        tracep->fullQData(oldp+121,(vlSelf->top__DOT__common_reg__DOT__ram[22]),64);
        tracep->fullQData(oldp+123,(vlSelf->top__DOT__common_reg__DOT__ram[23]),64);
        tracep->fullQData(oldp+125,(vlSelf->top__DOT__common_reg__DOT__ram[24]),64);
        tracep->fullQData(oldp+127,(vlSelf->top__DOT__common_reg__DOT__ram[25]),64);
        tracep->fullQData(oldp+129,(vlSelf->top__DOT__common_reg__DOT__ram[26]),64);
        tracep->fullQData(oldp+131,(vlSelf->top__DOT__common_reg__DOT__ram[27]),64);
        tracep->fullQData(oldp+133,(vlSelf->top__DOT__common_reg__DOT__ram[28]),64);
        tracep->fullQData(oldp+135,(vlSelf->top__DOT__common_reg__DOT__ram[29]),64);
        tracep->fullQData(oldp+137,(vlSelf->top__DOT__common_reg__DOT__ram[30]),64);
        tracep->fullQData(oldp+139,(vlSelf->top__DOT__common_reg__DOT__ram[31]),64);
