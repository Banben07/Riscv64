...
void VYSYX_22040125_B_CHECK___024root___ctor_var_reset(VYSYX_22040125_B_CHECK___024root* vlSelf);

VYSYX_22040125_B_CHECK___024root::VYSYX_22040125_B_CHECK___024root(const char* _vcname__)
    : VerilatedModule(_vcname__)
 {
    // Reset structure values
    VYSYX_22040125_B_CHECK___024root___ctor_var_reset(this);
}

void VYSYX_22040125_B_CHECK___024root::__Vconfigure(VYSYX_22040125_B_CHECK__Syms* _vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->vlSymsp = _vlSymsp;
}

VYSYX_22040125_B_CHECK___024root::~VYSYX_22040125_B_CHECK___024root() {
}

void VYSYX_22040125_B_CHECK___024root____Vdpiimwrap_top__DOT__common_reg__DOT__set_gpr_ptr__Vdpioc2_TOP(const VlUnpacked<QData/*63:0*/, 32> &a);
void VYSYX_22040125_B_CHECK___024root____Vdpiimwrap_top__DOT__data_ram__DOT__set_ram_ptr__Vdpioc2_TOP(const VlUnpacked<QData/*63:0*/, 2> &a);
extern const VlWide<13>/*415:0*/ VYSYX_22040125_B_CHECK__ConstPool__CONST_100c5227_0;

void VYSYX_22040125_B_CHECK___024root___initial__TOP__2(VYSYX_22040125_B_CHECK___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VYSYX_22040125_B_CHECK__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VYSYX_22040125_B_CHECK___024root___initial__TOP__2\n"); );
    // Body
    VYSYX_22040125_B_CHECK___024root____Vdpiimwrap_top__DOT__common_reg__DOT__set_gpr_ptr__Vdpioc2_TOP(vlSelf->top__DOT__common_reg__DOT__reg_com);
    VYSYX_22040125_B_CHECK___024root____Vdpiimwrap_top__DOT__data_ram__DOT__set_ram_ptr__Vdpioc2_TOP(vlSelf->top__DOT__data_ram__DOT__ram);
    VL_READMEM_N(true, 32, 65536, 0, VL_CVT_PACK_STR_NW(13, VYSYX_22040125_B_CHECK__ConstPool__CONST_100c5227_0)
                 ,  &(vlSelf->top__DOT__inst_ram__DOT__rom)
                 , 0, ~0ULL);
}

void VYSYX_22040125_B_CHECK___024root___settle__TOP__3(VYSYX_22040125_B_CHECK___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VYSYX_22040125_B_CHECK__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VYSYX_22040125_B_CHECK___024root___settle__TOP__3\n"); );
    // Variables
...
void VYSYX_22040125_B_CHECK___024root___eval_initial(VYSYX_22040125_B_CHECK___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VYSYX_22040125_B_CHECK__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VYSYX_22040125_B_CHECK___024root___eval_initial\n"); );
    // Body
    vlSelf->__Vclklast__TOP__clk = vlSelf->clk;
    VYSYX_22040125_B_CHECK___024root___initial__TOP__2(vlSelf);
}

void VYSYX_22040125_B_CHECK___024root___eval_settle(VYSYX_22040125_B_CHECK___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VYSYX_22040125_B_CHECK__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VYSYX_22040125_B_CHECK___024root___eval_settle\n"); );
    // Body
    VYSYX_22040125_B_CHECK___024root___settle__TOP__3(vlSelf);
...
void VYSYX_22040125_B_CHECK___024root___final(VYSYX_22040125_B_CHECK___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VYSYX_22040125_B_CHECK__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VYSYX_22040125_B_CHECK___024root___final\n"); );
}

void VYSYX_22040125_B_CHECK___024root___ctor_var_reset(VYSYX_22040125_B_CHECK___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VYSYX_22040125_B_CHECK__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VYSYX_22040125_B_CHECK___024root___ctor_var_reset\n"); );
    // Body
