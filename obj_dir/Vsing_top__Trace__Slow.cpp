...
void Vsing_top___024root__traceInitSub0(Vsing_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+29,"top id_reg inst", false,-1, 31,0);
        tracep->declQuad(c+55,"top id_reg if_pc", false,-1, 63,0);
        tracep->declBus(c+32,"top id_reg id_inst_id", false,-1, 31,0);
        tracep->declQuad(c+61,"top id_reg id_reg_pc", false,-1, 63,0);
        ...
        tracep->declQuad(c+61,"top exe_reg id_reg_pc", false,-1, 63,0);
        tracep->declBus(c+26,"top exe_reg exe_op_in", false,-1, 11,0);
        tracep->declBus(c+22,"top exe_reg exe_reg_rd_in", false,-1, 4,0);
        tracep->declQuad(c+69,"top exe_reg exe_reg_src1_in", false,-1, 63,0);
        tracep->declBus(c+8,"top exe_reg exe_reg_src1_sel_in", false,-1, 1,0);
        tracep->declQuad(c+71,"top exe_reg exe_reg_src2_in", false,-1, 63,0);
        ...
        tracep->declBus(c+12,"top exe_reg exe_op_in0", false,-1, 1,0);
        tracep->declQuad(c+33,"top exe_reg exe_op_in1", false,-1, 63,0);
