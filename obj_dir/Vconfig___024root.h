...
#ifndef VERILATED_VCONFIG___024ROOT_H_
#define VERILATED_VCONFIG___024ROOT_H_  // guard
...
class Vconfig__Syms;
class Vconfig_VerilatedVcd;


//----------

VL_MODULE(Vconfig___024root) {
  public:
    ...
    VlUnpacked<QData/*63:0*/, 32> top__DOT__common_reg__DOT__ram;
    ...
    // INTERNAL VARIABLES
    Vconfig__Syms* vlSymsp;  // Symbol table

    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vconfig___024root);  ///< Copying not allowed
  public:
    Vconfig___024root(const char* name);
    ~Vconfig___024root();

    // INTERNAL METHODS
    void __Vconfigure(Vconfig__Syms* symsp, bool first);
