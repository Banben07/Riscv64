...
void Vconfig___024root___ctor_var_reset(Vconfig___024root* vlSelf);

Vconfig___024root::Vconfig___024root(const char* _vcname__)
    : VerilatedModule(_vcname__)
 {
    // Reset structure values
    Vconfig___024root___ctor_var_reset(this);
}

void Vconfig___024root::__Vconfigure(Vconfig__Syms* _vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->vlSymsp = _vlSymsp;
}

Vconfig___024root::~Vconfig___024root() {
}

extern const VlWide<15>/*479:0*/ Vconfig__ConstPool__CONST_6aa5eb1b_0;

void Vconfig___024root___initial__TOP__1(Vconfig___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vconfig___024root___initial__TOP__1\n"); );
    // Body
    VL_READMEM_N(false, 32, 256, 0, VL_CVT_PACK_STR_NW(15, Vconfig__ConstPool__CONST_6aa5eb1b_0)
                 ,  &(vlSelf->top__DOT__inst_ram__DOT__rom)
                 , 0, ~0ULL);
}

void Vconfig___024root____Vdpiimwrap_top__DOT__ebreak_check_TOP(IData/*31:0*/ a, IData/*31:0*/ &ebreak_check__Vfuncrtn);

void Vconfig___024root___settle__TOP__3(Vconfig___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vconfig___024root___settle__TOP__3\n"); );
    // Variables
...
void Vconfig___024root___eval_initial(Vconfig___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vconfig___024root___eval_initial\n"); );
    // Body
    Vconfig___024root___initial__TOP__1(vlSelf);
...
void Vconfig___024root___eval_settle(Vconfig___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vconfig___024root___eval_settle\n"); );
    // Body
    Vconfig___024root___settle__TOP__3(vlSelf);
...
void Vconfig___024root___final(Vconfig___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vconfig___024root___final\n"); );
}

void Vconfig___024root___ctor_var_reset(Vconfig___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vconfig__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vconfig___024root___ctor_var_reset\n"); );
    // Body
    ...
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        vlSelf->top__DOT__common_reg__DOT__ram[__Vi0] = VL_RAND_RESET_Q(64);
    }
    for (int __Vi0=0; __Vi0<2; ++__Vi0) {
